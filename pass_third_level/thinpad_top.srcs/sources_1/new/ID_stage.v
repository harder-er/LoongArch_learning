...
module id_stage(
    ...
    //
    input [ 4                 :0] WB_dest,EXE_dest,MEM_dest,
...
//访存的
assign mem_we        = reset?1'b0:(inst_st_w | inst_st_b | inst_st_h);
...
assign reg1_valid = (inst_add_w | inst_sub_w | inst_slt | inst_addi_w | inst_sltu | inst_nor | inst_and | inst_or | inst_xor 
                    ...
                    | inst_ld_b | inst_ld_bu | inst_ld_h | inst_ld_hu | inst_st_b | inst_st_h)&(rf_raddr1 != 5'h0);
assign reg2_valid = (inst_add_w | inst_sub_w | inst_slt | inst_sltu | inst_and | inst_or 
                    ...
                    | inst_mul_w | inst_mulh_w | inst_mulh_wu | inst_div_w | inst_div_wu | inst_mod_w | inst_mod_wu
                    | inst_blt | inst_bge | inst_bltu | inst_bgeu)&(rf_raddr2 != 5'h0);
//lab8
...
//                                             |(EXE_dest==rf_raddr2) & reg2_valid)))&(~if_stall);
