...
assign load_op       = if_to_ds_stall?1'b0:inst_ld_w | inst_ld_b | inst_ld_bu | inst_ld_h | inst_ld_hu;
...
assign ds_ready_go = ~( es_load_valid&&(~if_to_ds_stall) & ((EXE_dest==rf_raddr1) & reg1_valid
