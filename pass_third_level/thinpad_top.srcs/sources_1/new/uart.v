...
//     else if (read_flag) 
//         ext_uart_buffer <= {6'h0,ext_uart_avai,~ext_uart_busy};
//     else if (write_uart)
//         ext_uart_buffer <= conf_wdata[7:0];
//     else if (read_uart)
...
//         ext_uart_avai <= 1;
//     end else if(!ext_uart_busy && read_uart) 
//         ext_uart_avai <= 0;
// end
// always @(posedge clk) begin //将缓冲区ext_uart_buffer发送出去
//     if(!ext_uart_busy && write_uart)begin 
...
//     );
// assign conf_rdata = {24'h0,ext_uart_buffer};
