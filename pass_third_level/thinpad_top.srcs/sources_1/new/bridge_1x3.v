...
//   
//     master:    cpu_data/home/zgh/learn_files/vivado_ex/12_1_23_38/fpga_template_la_utf8_2/thinpad_top.srcs/sources_1/new/bridge_1x3.v
//                 /  |  \
//     1 x 3      /   |   \  
//     bridge:   /    |    \                    
//              /     |     \       
...
`define CONF_ADDR_MASK 32'hffc0_0000//1111 1111 1100
module bridge_1x3(                                 
    input                           clk,          // clock 
    ...
    wire sel_mem;
    assign sel_mem = (es_load_valid|data_sram_en);
    assign sel_inst = (data_sram_addr[31:22] == 10'h200)&sel_mem;
    assign sel_data = (data_sram_addr[31:22] == 10'h201)&sel_mem;
    // assign sel_inst = (data_sram_addr & `CONF_ADDR_MASK) == `CONF_ADDR_INST;
    // assign sel_data = (data_sram_addr & `CONF_ADDR_MASK) == `CONF_ADDR_DATA;
    assign sel_conf = ((data_sram_addr == 32'hbfd003fc)|(data_sram_addr == 32'hbfd003f8))&sel_mem;
    ...
    assign is_base = ((es_load_VALID|data_sram_EN)&sel_inst_r)|inst_sram_en;
    assign is_ext  = (es_load_VALID|data_sram_EN)&sel_data_r;
    ...
    assign mem_addr = !resetn?20'h0:es_load_VALID|data_sram_EN?data_sram_ADDR[21:2]:inst_sram_addr[21:2];
    assign inst_sram_rdata = mem_rdata;
   
    assign mem_wdata = data_sram_WDATA;
    reg IF_stall;
    assign if_stall = !resetn?1'b0:data_sram_EN|es_load_VALID;
    ...
    assign conf_re    = es_load_VALID&sel_conf_r;
    assign conf_we    = data_sram_EN&sel_conf_r;
    // assign conf_wen   = data_sram_WEN;
    assign conf_addr  = data_sram_ADDR;
    assign conf_wdata = data_sram_WDATA;
    // assign conf_en = (data_sram_en | es_load_valid) & sel_conf;
    // assign conf_wen = data_sram_wen;
    // assign conf_addr = data_sram_addr;
    // assign conf_wdata = data_sram_wdata;
    always @ (posedge clk)
