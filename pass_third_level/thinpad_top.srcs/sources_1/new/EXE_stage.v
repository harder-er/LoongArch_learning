...
// assign es_exe_result = es_alu_result;
assign es_to_ms_bus = {
                        es_inst_ld_b    ,//75
                        es_inst_ld_bu   ,
                        es_inst_ld_h    ,
...
assign data_sram_we = es_valid?es_inst_st ? st_op : 4'hf:4'hf;
// assign data_sram_we = 4'b1111;
assign data_sram_addr  = es_valid?es_alu_result:32'h0;
// assign data_sram_addr = 32'b0;
assign data_sram_wdata = st_data;

assign data_sram_en    = reset?1'b0:(es_mem_we&&es_valid);

// assign es_st_valid  = data_sram_en;
