...
parameter BASE_RAM_INIT_FILE = "/home/zgh/learn_files/vivado_ex/fpga_template_la_utf8/lab2.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "/tmp/eram.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
parameter FLASH_INIT_FILE = "/home/zgh/learn_files/vivado_ex/fpga_template_la_utf8/kernel.elf";    //Flash初始化文件，请修改为实际的绝对路径
